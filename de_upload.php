               ...
               <div class="col-md-offset-1 col-md-10 col-sm-12">
                    ...
                    <div class="blog-post-thumb">
                         ...
                         <form action="de_upload.php" enctype="multipart/form-data" method="post">
                            <div class="img_wrap">
                                <div class="left">
                                    <center><p>Upload your image on right hand side.</p>
                                        ...
                                        //     $filepath = $_FILES["de_file"]["name"];
                                            $filepath = './encrypt.jpg';
                                            $_SESSION['de_img_path']= $filepath;
                                            ...
                                            echo "<img src=".$_SESSION['de_img_path']." height=300 width=300 />";
                                        }
                                        ?>
                                        </br>
                                ...
                                <div class="right">
                                    <center><p>Click decrypted picture to download.</p></center>
                                        <?php
                                          if(isset($_POST['decrypt_img']))
                                          {   
                                              // echo $_SESSION['img_path'];
                                              // pass filepath to python
                                             //  $de_filepath = './'. $_SESSION['de_img_path'];
                                              // echo $py_filepath;
                                              $pythonScriptCall = 'python decrypt.py';
                                              $pythonScriptResult = '';
                                              ...
                                              if ($pythonScriptResult == ''){
                                                  ...
                                                  $decrypt_filepath = "decrypt.jpg";
                                                  echo "<center><img src=".$decrypt_filepath." height=300 width=300 /></center>";
                                              }
                                          }
                                        ?>
                            ...
                            <div class="blog-post-des">
                                  <center><input type="submit" value="Decrypted Image" name="decrypt_img" class="btn btn-default"></center>
                            </div>
